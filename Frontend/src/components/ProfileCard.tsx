    ...
    <article className='rounded-2xl border border-[color:var(--border)] bg-[color:var(--surface)] p-6 shadow-[var(--shadow)]'>
      <div className='flex flex-col gap-4 sm:flex-row sm:items-center'>
        {data.person?.thumbnail ? (
          ...
          <div className='grid h-16 w-16 place-items-center rounded-2xl bg-[color:var(--background)] text-lg font-semibold text-[color:var(--primary)]'>
            {title?.slice(0, 2) || 'NP'}
          </div>
        )}
        <div>
      ...
      <p className='mt-4 text-sm leading-relaxed text-[color:var(--text)]'>
