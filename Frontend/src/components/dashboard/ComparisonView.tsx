...
import { Plus, X, TrendingUp, TrendingDown, Minus, Users, MessageSquare, BarChart3 } from 'lucide-react'
...
interface ProjectStats {
  ...
  dailyMentions: number[] // Last 7 days
  engagement: { likes: number; comments: number; shares: number }
}

// Colors for different projects in comparison
...
export default function ComparisonView({ 
  ...
  // Calculate stats for each selected project
  const projectStats = useMemo(() => {
    return selectedProjects.map(projectId => {
      ...
      // Daily mentions for last 7 days
